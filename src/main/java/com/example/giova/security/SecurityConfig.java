package com.example.giova.security;

import com.example.giova.service.UserDetailsServiceImpl; //importando el servicio que creé
...
public class SecurityConfig {
    ...
    //constructor para inicializar servicio para obtener detalles de usuarios.
    public SecurityConfig(UserDetailsServiceImpl UserDetailsService){
        this.UserDetailsService = UserDetailsService;
    }
 // método para filtrar seguridad
    @Bean
    ...
    //método para obtener datos del usuario. Función: autenticar usuarios utilizando UserDetailsService y PasswordEncoder
    @Bean
